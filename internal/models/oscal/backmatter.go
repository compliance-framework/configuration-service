...
import "github.com/compliance-framework/configuration-service/internal/models/oscal/metadata"
...
type Resource struct {
	...
	Rlinks      []metadata.Link      `json:"rlinks,omitempty"`       // Related links of the resource.
...
type Citation struct {
	Links []metadata.Link `json:"links,omitempty"` // Links associated with the citation.
